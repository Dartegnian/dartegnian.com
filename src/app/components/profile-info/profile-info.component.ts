...
export class ProfileInfoComponent implements OnInit {
	...
	constructor() {
		this.description = "Hi, I'm Dartegnian Velarde. I’m an agile and determined DevOps engineer with a passion for curating innovative and responsive web applications, with highly-functional knowledge of various web technologies and computer programming. Communicating well with others, troubleshooting, and fluency in English are some of my other skills. Adaptability and conscientiousness are my predominant traits.";
	}
